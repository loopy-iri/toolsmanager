...
فرانت‌اند در `http://localhost:5173` و API توسعه در `http://localhost:3000` در دسترس است. در محیط توسعه رمز اولیه همه کاربران `ToolManager123!` است؛ فقط برای توسعه است و بعد از ورود در محیط واقعی باید تعویض شود.
